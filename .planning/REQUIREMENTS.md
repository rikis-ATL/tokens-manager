...
- [ ] **DB-01**: App connects to MongoDB via environment variable connection string
- [ ] **DB-02**: MongoDB connection is established on server startup and reused across requests (singleton connection)
