...
function toDoc(raw: Record<string, unknown>): CollectionDoc {
  return {
    ...
    npmPackageName: (raw.npmPackageName as string | null) ?? null,
    npmRegistryUrl: (raw.npmRegistryUrl as string | null) ?? null,
    npmTokenConfigured: !!(raw.npmTokenEncrypted && raw.npmTokenIv),
    npmTokenEncrypted: (raw.npmTokenEncrypted as string | null) ?? undefined,
    npmTokenIv: (raw.npmTokenIv as string | null) ?? undefined,
    graphState: (raw.graphState as CollectionDoc['graphState']) ?? null,
    isPlayground: (raw.isPlayground as boolean) ?? false,
    accentColor: (raw.accentColor as string | null) ?? null,
